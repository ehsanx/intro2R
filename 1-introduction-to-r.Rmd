...
#### DO QUESTIONS 1-3 OF THE GOOGLE QUIZ NOW
...
![Figure 1. Arithmetic Operators in R](https://i.imgur.com/1ww25MM.png)
...
![Figure 2. Logical Operators in R](https://i.imgur.com/xG4F5kA.png)
...
list(
> **VARIABLE NAME OF ANY DATA TYPE** = **ANY DATA STORED WITHIN THAT VARIABLE** OR **ANY STRING**
...
## 8. HELP WITHIN AND OUTSIDE OF R
...
![Figure 3. Help window in RStudio](https://i.imgur.com/M9KAqcj.png)
