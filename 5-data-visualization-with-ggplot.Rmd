...
geom_point(
> aes(**AESTHETICS** - to be covered later in the tutorial),
...
## 3. MULTIPLE GEOMETRIC FUNCTIONS UNDER ONE GGPLOT
...
> formula = **FORMULA TO USE IN SMOOTHING FUNCTION**, usually y ~ x when there are less than 1,000 observations
