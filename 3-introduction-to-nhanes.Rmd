...
![image](https://i.imgur.com/8uGOUmc.png)
...
![image](https://i.imgur.com/I94dBUa.png)
...
## 2. Importing NHANES dataset from website
...
![image](https://i.imgur.com/wUReKXp.png)

Then, you will see the following page:

![image](https://i.imgur.com/MhlrkEn.png)
...
## 3. Importing NHANES dataset from R package: nhanesA
...
> Fill in the blank to answer 'Try it yourself 3.2':
...
The function that we went over in this tutorial is originally written by **___**. For simplification and educational purposes, the function has been simplified. You can find the original function here (**need to insert link to document**).
